...
public final class RemoteLocalServicesStore implements LocalServicesStore {
    ...
    public static final class Factory {
        ...
        public static RemoteLocalServicesStore create(RemoteServicesStore remoteServicesStore, RemoteStateSiteRegistry<?> siteRegistry, RemoteServiceRegistrationMapper mapper) {
